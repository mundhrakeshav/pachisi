...
import "./nftLeftColumn.css";

const NFTLeftColumnPriceFeeds = () => {
  return (
    <Container className="left-column-container">
      <Col className="left-button-column">
        ...
        <Row className="left-button-row">
          <Link to="/nftPage/stocks" className="nav-button">
            <Button className="left-column-button-pricefeeds">Stocks</Button>{" "}
          </Link>
        </Row>{" "}
        <Row className="left-button-row">
          <Link to="/nftPage/forex" className="nav-button">
...
export default NFTLeftColumnPriceFeeds;
