...
contract ERC777Dai is Ownable, ERC20Token, ERC777Token, ERC820Implementer {
    ...
    function name() public returns (string) { return mName; }

    /// @return the symbol of the token
    function symbol() public returns (string) { return mSymbol; }

    /// @return the granularity of the token
    function granularity() public returns (uint256) { return mGranularity; }

    /// @return the total supply of the token
    function totalSupply() public returns (uint256) { return mTotalSupply; }

    /// @notice Return the account balance of some account
    /// @param _tokenHolder Address for which the balance is returned
    /// @return the balance of `_tokenAddress`.
    function balanceOf(address _tokenHolder) public returns (uint256) { return mBalances[_tokenHolder]; }
    ...
    function isOperatorFor(address _operator, address _tokenHolder) public returns (bool) {
    ...
    function decimals() public erc20 returns (uint8) { return uint8(18); }
    ...
    ///  to spend
    function allowance(address _owner, address _spender) public erc20 returns (uint256 remaining) {
    ...
    function isRegularAddress(address _addr) internal returns(bool) {
